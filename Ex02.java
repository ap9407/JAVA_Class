...
public class Ex02 {
	public static void main(String[] args) {
		...
		int[] arr1; // 정수형 배열을 참조 할 수 있는 참조변수만 선언(실제 배열은 없음)
		int arr2[]; // C언어에서는 변수 이름 뒤에 []를 작성해야만 한다. (자바는 둘다 가능)
		...
		int[] arr5 = new int[5];
		// 배열의 요소를 명시하지 않고, 빈칸만으로 배열을 생성할 수 있으며, 길이가 필요함.
		
//		int[] arr6 = new int[5] { 1, 2, 3, 4, 5 };
		// 배열을 생성할 때는 길이 혹은 요소를 명시하며, 둘다 명시하면 문법상 틀림.
		
		System.out.println(arr3); // 특정 객체를 참조하기 때문에, 객체의 hashcode 가 출력됨.
		showArray(arr3);
