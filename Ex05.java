...
public class Ex05 {
	public static void main(String[] args) throws IOException {
		...
		Scanner sc3 = new Scanner(in); // 표준입력의내용을 읽어들이는 Scanner

		// Scanner()라는 함수의 이름은 하나인데
		// 매개변수의 자료형에 따라서, 실제로는 3개의 함수가 각각 따로 존재한다.
		// 매개변수에 넣어주는 인자값의 자료형에 따라 서로 다른 함수를 실행하는것이다.
	...
	// 두 정수를 전달받아서 합께를 반환하는 함수 sum
	static int sum(int n1, int n2) {
		return n1 + n2;
	}

	// 세 정수를 입력받아서 합계를 반환하는 함수 sum
	static int sum(int n1, int n2, int n3) {
		return n1 + n2 + n3;
	}

	// 여러 정수를 전달받아서(int[]) 합게를 반환하는 함수 sum
	...
	// Doublicate method sum(int, int) in type Ex05
