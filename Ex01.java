...
//		System.out.println(10 / 3); 		// 1번 통로
//		System.out.println(10 / 0);			// 2번 통로
		
		System.out.print("아무 키나 입력하세요 : ");
		int data = System.in.read();		//keyCode를 정수로 입력받는다.(제일 앞에 값만 읽는다)
		System.out.println("data : " + data);
		System.out.println((char)44032);	//char = 2byte(16bit) = 65536
