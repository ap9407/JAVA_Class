...
public class Ex01 {
	public static void main(String[] args) {
		...
		System.out.println(str1 == str2); // 바라보는 곳이 다르기때문에 값이 다르다.
		System.out.println(str1 == str3); // 새로만들어라고 지시했기때문에 다르다.(new)
		System.out.println(str2 == str3); // 새로만들어라고 지시했기때문에 다르다.(new)
		System.out.println(str2 == str4); // 새로만들어라는 지시가 없었고, 바라보는 대상이 같기때문에 값이 같다.
